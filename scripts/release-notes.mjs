...
export function renderReleaseNotes({ tag, artifacts }) {
...
The zip contains \`Codex Bar.app\` for macOS. The app is ad-hoc signed and verified by CI, but it is not notarized yet. macOS may require approval on first launch.
